...
- ⚠️ **subtitle_shift** (L1): 9 条空译文（可能是平移或降级失败）: [19, 20, 192, 199, 206]
  - 相关代码: translate.rs translate_batch_with_fallback
- ❌ **empty_translations** (L2): 9 条空译文: [19, 20, 192, 199, 206]
  - 相关代码: translate.rs translate_batch_with_fallback 降级重试
- ⚠️ **fake_translations** (L2): 假翻译 18 条 (3.21%)
  - 相关代码: translate.rs prompt 模板
- ❌ **cjk_check** (L2): 26 条译文无 CJK 字符: [30, 31, 32, 33, 39]
  - 相关代码: translate.rs prompt 或模型不支持中文
- ⚠️ **sound_effect_consistency** (L2): 5 条音效标记不一致: [(244, false, true), (245, false, true), (247, false, true)]
...
- ⚠️ **translate_failures** (L2): 失败 40 条, 缓存 0 条, token 59165
  - 相关代码: translate.rs translate_batch_with_fallback
