...
- ✅ **translate_failures** (L2): 失败 0 条, 缓存 3040 条, token 0
  - 相关代码: translate.rs translate_batch_with_fallback
- ⚠️ **judge_27b** (L5): 27b judge: 444 pass, 88 fail, 28 shift (共 560 条判定, 问题批次: [5, 6, 8, 9, 10, 13, 17])
