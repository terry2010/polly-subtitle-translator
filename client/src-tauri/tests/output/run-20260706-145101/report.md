...
- ✅ **translate_failures** (L2): 失败 0 条, 缓存 1150 条, token 0
  - 相关代码: translate.rs translate_batch_with_fallback
- ⚠️ **judge_27b** (L5): 27b judge: 277 pass, 52 fail, 21 shift (共 350 条判定, 问题批次: [1, 2, 3, 4, 7, 11, 12, 14, 15, 16, 18, 19])
