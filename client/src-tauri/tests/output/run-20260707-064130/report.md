...
|---------|--------|------|----------------|
| Rick.and.Morty.S09E07.1080p.WEB.h264-EDITH[EZTVx.to].eng | 501 | ⚠️ warned | 17/4/0 |
...
- ⚠️ **translate_failures** (L2): 失败 8 条, 缓存 450 条, token 34244
  - 相关代码: translate.rs translate_batch_with_fallback
