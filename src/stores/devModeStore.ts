    ...
    try {
      ...
      if (isDevMode) {
        ...
        if (newCount >= AUTO_DISABLE_RESTART_COUNT) {
          ...
          set({ devMode: false, initialized: true, logApiEnabled, namePrecisionEnabled, updateChannel });
          ...
          set({ devMode: true, initialized: true, logApiEnabled, namePrecisionEnabled, updateChannel });
      ...
      set({ devMode: false, initialized: true, logApiEnabled: false, namePrecisionEnabled: false, updateChannel: "stable" });
      setDevModeEnabled(false);
      api.setDevMode(false).catch(() => {});
    }
  },
