...
export const SERVICES: ServiceDef[] = [
  ...
  { id: "zhipu",      name: "智谱GLM",    category: "ai", freeQuota: "GLM-4.7-Flash 无限免费（QPS=1）", price: "-", completelyFree: false, hasFreeTier: true,  comingSoon: false, requiresApiKey: true,  docUrl: "https://open.bigmodel.cn/", description: "GLM-4.7-Flash 无限免费，QPS=1", presetBaseUrl: "https://open.bigmodel.cn/api/paas/v4", presetQps: 1, isOpenAiCompatible: true },
