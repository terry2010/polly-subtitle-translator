...
export const SERVICES: ServiceDef[] = [
  ...
  { id: "siliconflow",name: "硅基流动",   category: "ai", freeQuota: "Qwen2.5-7B 等免费", price: "-", completelyFree: false, hasFreeTier: true,  comingSoon: false, requiresApiKey: true,  docUrl: "https://cloud.siliconflow.cn/i/rSzssNX2", description: "聚合多厂商模型，部分模型免费", presetBaseUrl: "https://api.siliconflow.cn/v1", presetQps: 10, isOpenAiCompatible: true },
