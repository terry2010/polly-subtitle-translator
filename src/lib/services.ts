...
export const SERVICES: ServiceDef[] = [
  // ── 传统翻译 ──
  { id: "baidu",      name: "百度翻译",   category: "traditional", freeQuota: "每月100万字符", price: "49元/100万字符", completelyFree: false, hasFreeTier: true,  comingSoon: false, requiresApiKey: false, docUrl: "https://fanyi-api.baidu.com/", description: "支持中英等多语言，每月 100 万字符免费", appIdLabel: "App ID", appIdPlaceholder: "百度翻译 App ID" },
  { id: "bing",       name: "Microsoft",  category: "traditional", freeQuota: "每月200万字符", price: "10美元/100万字符", completelyFree: false, hasFreeTier: true, comingSoon: false, requiresApiKey: false, docUrl: "https://learn.microsoft.com/azure/cognitive-services/translator/", description: "Azure Translator，每月 200 万字符免费", appIdLabel: "API Key", appIdPlaceholder: "Azure Translator API Key", hasRegion: true },
  { id: "google",     name: "Google",     category: "traditional", freeQuota: "每月50万字符",  price: "20美元/100万字符", completelyFree: false, hasFreeTier: true, comingSoon: false, requiresApiKey: false, docUrl: "https://cloud.google.com/translate/docs/", description: "Google Cloud Translate，每月 50 万字符免费", appIdLabel: "API Key", appIdPlaceholder: "Google Cloud Translation API Key" },
  // 以下传统翻译为「待开发」
  { id: "tencent",    name: "腾讯翻译君", category: "traditional", freeQuota: "每月500万字符", price: "58元/100万字符", completelyFree: false, hasFreeTier: true, comingSoon: false, requiresApiKey: false, docUrl: "https://cloud.tencent.com/product/tmt", description: "每月 500 万字符免费，支持多语种", appIdLabel: "SecretId", appIdPlaceholder: "腾讯云 SecretId" },
  { id: "volcengine", name: "火山翻译",   category: "traditional", freeQuota: "每月200万字符", price: "49元/100万字符", completelyFree: false, hasFreeTier: true, comingSoon: false, requiresApiKey: false, docUrl: "https://www.volcengine.com/product/translate", description: "字节跳动翻译，每月 200 万字符免费", appIdLabel: "Access Key ID", appIdPlaceholder: "火山引擎 Access Key ID" },
  { id: "aliyun",     name: "阿里翻译",   category: "traditional", freeQuota: "每月100万字符", price: "50元/100万字符", completelyFree: false, hasFreeTier: true, comingSoon: false, requiresApiKey: false, docUrl: "https://www.aliyun.com/product/ai/alimt", description: "阿里云机器翻译，每月 100 万字符免费", appIdLabel: "Access Key ID", appIdPlaceholder: "阿里云 Access Key ID" },
  { id: "deepl",      name: "DeepL",      category: "traditional", freeQuota: "每月50万字符",  price: "4.99€/月+20€/100万字符", completelyFree: false, hasFreeTier: true, comingSoon: false, requiresApiKey: false, docUrl: "https://www.deepl.com/pro-api", description: "翻译质量高，每月 50 万字符免费", appIdLabel: "Auth Key", appIdPlaceholder: "DeepL Auth Key" },
  { id: "youdao",     name: "有道翻译",   category: "traditional", freeQuota: "无", price: "48元/100万字符", completelyFree: false, hasFreeTier: false, comingSoon: false, requiresApiKey: false, docUrl: "https://ai.youdao.com/", description: "网易有道翻译 API", appIdLabel: "App ID", appIdPlaceholder: "有道翻译 App ID" },
  { id: "caiyun",     name: "彩云小译",   category: "traditional", freeQuota: "无", price: "39元/100万字符", completelyFree: false, hasFreeTier: false, comingSoon: false, requiresApiKey: false, docUrl: "https://dashboard.caiyunapp.com/", description: "彩云科技翻译 API", appIdLabel: "Token", appIdPlaceholder: "彩云小译 Token" },
  { id: "niutrans",   name: "小牛翻译",   category: "traditional", freeQuota: "每日20万字符", price: "500元/1000万字符", completelyFree: false, hasFreeTier: true, comingSoon: false, requiresApiKey: false, docUrl: "https://niutrans.com/", description: "每日 20 万字符免费", appIdLabel: "API Key", appIdPlaceholder: "小牛翻译 API Key" },
  ...
  { id: "zhipu",      name: "智谱GLM",    category: "ai", freeQuota: "GLM-4-Flash 无限免费", price: "-", completelyFree: false, hasFreeTier: true,  comingSoon: false, requiresApiKey: true,  docUrl: "https://open.bigmodel.cn/", description: "GLM-4-Flash 无限免费", presetBaseUrl: "https://open.bigmodel.cn/api/paas/v4", presetQps: 10, isOpenAiCompatible: true },
  { id: "siliconflow",name: "硅基流动",   category: "ai", freeQuota: "Qwen2.5-7B 等免费", price: "-", completelyFree: false, hasFreeTier: true,  comingSoon: false, requiresApiKey: true,  docUrl: "https://siliconflow.cn/", description: "聚合多厂商模型，部分模型免费", presetBaseUrl: "https://api.siliconflow.cn/v1", presetQps: 10, isOpenAiCompatible: true },
