...
export const SERVICES: ServiceDef[] = [
  ...
  { id: "zhipu",      name: "智谱GLM",    category: "ai", freeQuota: "GLM-4.7-Flash 无限免费（QPS<1）", price: "-", completelyFree: false, hasFreeTier: true,  comingSoon: false, requiresApiKey: true,  docUrl: "https://open.bigmodel.cn/", description: "GLM-4.7-Flash 无限免费，QPS 需小于 1", presetBaseUrl: "https://open.bigmodel.cn/api/paas/v4", presetQps: 0.5, isOpenAiCompatible: true },
  { id: "siliconflow",name: "硅基流动",   category: "ai", freeQuota: "多种免费小参数模型", price: "-", completelyFree: false, hasFreeTier: true,  comingSoon: false, requiresApiKey: true,  docUrl: "https://siliconflow.cn/", description: "聚合多厂商模型，部分模型免费", presetBaseUrl: "https://api.siliconflow.cn/v1", presetQps: 10, isOpenAiCompatible: true, modelRecommendation: "免费模型： GLM-4-9B 翻译质量较好，Qwen3-8B 质量可接受；不要选择比qwen3更早发布的模型，不要选择比8b参数更少的模型<br/>付费模型：建议选择 25B 以上参数且性价比高的型号，如 DeepSeek-V4-Flash。<br/> 作者资金有限，仅完整测试了少量收费模型，其余请自行试用评估。" },
  ...
  { id: "hunyuan",    name: "混元",       category: "ai", freeQuota: "新用户每个模型 100 万 tokens（90 天）", price: "0.3元/百万tokens起", completelyFree: false, hasFreeTier: true,  comingSoon: false, requiresApiKey: true,  docUrl: "https://console.cloud.tencent.com/tokenhub", description: "腾讯 TokenHub 平台，旧版 hunyuan-lite 已下线，新用户有免费体验额度", presetBaseUrl: "https://tokenhub.tencentmaas.com/v1", presetQps: 10, isOpenAiCompatible: true },
